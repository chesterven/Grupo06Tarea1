...
public class DetalleSegundaRevision_Eliminar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        carnetEli = (EditText) findViewById(R.id.carnetDetalleSegundaEli);
        revisiones = (Spinner) findViewById(R.id.spinnerResultadosRevisionesEvaluaEli);
        codDocente = (EditText) findViewById(R.id.codigoDocenteDetalleSegundaEli);
    }
    public void consultarReviSegundaReviDetalleEli(View v)
    {
    ...
    public void eliminarDetalleSegundaRevision(View v)
    {
        if(!(listaRevisiones.size()==0))
        {
            ...
            carnetEli.getText().toString().equals(""))
            {
                ...
                siAlumno = DBHelper.consultarAlumnoSoliSegundaRevisionAntesDetalle(Integer.valueOf(idEvaluacion), carnetEli.getText().toString());
               if(siAlumno.equals(""))
               {
                   ...
                   if (existe == true) {
                       mensaje = DBHelper.eliminarDetalleSegundaRevision(Integer.valueOf(revisionParte[0]), Integer.valueOf(siAlumno));
