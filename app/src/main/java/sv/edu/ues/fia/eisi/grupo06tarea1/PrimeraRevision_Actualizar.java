...
public class PrimeraRevision_Actualizar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_primera_revision__actualizar);

        codDocente=(EditText)findViewById(R.id.idCodigoDocenteActualizarPrimera);
        fecha=(EditText) findViewById(R.id.fechaPrimeraRevisionAct);
        hora = (EditText) findViewById(R.id.horaPrimeraRevisionAct);
        descripcion= (EditText) findViewById(R.id.descripcionPrimeraRevisionAct);
        locales=(Spinner) findViewById(R.id.spinnerLocalesPrimeraAct);
        revisiones = (Spinner) findViewById(R.id.spinnerRevisionesDocentePrimeraAct);
    ...
    public void consultarEvaPrimeraReviAct(View v) {
    ...
    public void actualizarPrimeraRevision(View v)
    {
        if(!(listaRevisiones.size()==0)) {
            if (revisiones.getSelectedItem().toString().equals("Seleccione su revisión") |
                ...
                primera.setIdPrimeraRevision(Integer.valueOf(revisionParte[0]));
                ...
                mensaje = DBHelper.actualizarPrimeraRevision(primera);
