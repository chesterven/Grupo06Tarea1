...
public class SolicitudEvaluacion_Eliminar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_solicitud_evaluacion__eliminar);
        codDocente = (EditText) findViewById(R.id.SoliDifyRepEvaluacionDocenteEli);
        evalua = (Spinner) findViewById(R.id.spinnerSolicitudDifRepEvaluacionEli);
    ...
    public void eliminarNotaSolicitudEvaluacion(View v){
        if(!(solicitudesResultado.size()==0)){
            if(solicitudes.getSelectedItem().toString().equals("Seleccione solicitud")){
                ...
                String mensaje =DBHelper.eliminarSolicitudEvaluacion(evaluacionPart[0],solPart[0]);
